...
def main():
    ...
    print(f"{watermark}\n\n=== WELCOME TO THE TWITTER LIKES MEDIA DOWNLOADER (Brave) ===\n\nThanks for using this tool! ^^\n\nThis Python script uses ChromeDriver and Selenium with Brave to bulk-download all pieces of media from your Twitter likes, in the highest quality possible.\n*Keep in mind that gifs will NOT be downloaded as gifs but rather in video form to preserve quality.*\n\n")

    default_brave_dir = "C:/Program Files/BraveSoftware/Brave-Browser/Application"

    print("To begin, please select your Brave browser executable:")
